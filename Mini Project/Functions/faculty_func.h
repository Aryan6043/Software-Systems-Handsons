...
bool checkFaculty(struct faculty currUser)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Faculty.data", O_RDONLY, 0744);
        if (fd == -1)
        {
...
bool changeFacultyPass(struct faculty modUser)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Faculty.data", O_RDWR);
        if (fd == -1)
        {
...
bool addFaculty(struct faculty record, int sd)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Faculty.data", O_RDWR, 0744);
        if (fd == -1 && errno == ENOENT)
        {
                fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Faculty.data", O_RDWR | O_CREAT | O_APPEND, 0744);
                record.userID = 0;
                flag = 1;
        }
