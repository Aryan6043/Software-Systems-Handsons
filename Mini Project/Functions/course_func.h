...
{
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Course.data", O_RDWR | O_CREAT, 0744);
...
bool addNewCourse(struct course record, int sd)
{
        bool result = false;
        int fd;
        fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Course.data", O_RDWR | O_CREAT | O_APPEND, 0744);
        if (fd == -1)
        {
...
{
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Course.data", O_RDWR, 0744);
        int tmp_fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Course.data.tmp", O_RDWR | O_CREAT, 0744);
        ...
        remove("/home/aryan/Documents/Github/Mini-Project/Database/Course.data");
        rename("/home/aryan/Documents/Github/Mini-Project/Database/Course.data.tmp", "/home/aryan/Documents/Github/Mini-Project/Database/Course.data");
...
int availableSeats(int cid)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Course.data", O_RDONLY, 0744);
        if (fd == -1)
        {
                perror("Error opening file");
                return -1;
