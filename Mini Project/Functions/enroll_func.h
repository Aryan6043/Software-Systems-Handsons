...
bool enrollStudentCourse(struct enrollment record, int sd)
{
        ...
        if (avaiSeats > 0)
        {
                int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Enroll.data", O_RDWR | O_CREAT | O_APPEND, 0744);
                if (fd == -1)
                {
...
void deleteEnrollment(struct enrollment removeEnrollment, int sd)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Enroll.data", O_RDWR, 0744);
        if (fd == -1)
        {
                perror("Error opening Enroll.data");
                return;
        }
        int tmp_fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Enroll.data.tmp", O_RDWR | O_CREAT, 0744);
        if (tmp_fd == -1)
        {
        ...
        remove("/home/aryan/Documents/Github/Mini-Project/Database/Enroll.data");
        rename("/home/aryan/Documents/Github/Mini-Project/Database/Enroll.data.tmp", "/home/aryan/Documents/Github/Mini-Project/Database/Enroll.data");
...
void viewEnrolledCourses(int studentID, int sd)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Enroll.data", O_RDWR | O_CREAT, 0744);
        if (fd == -1)
        {
                perror("Error opening Enroll.data");
                return;
...
void unenrollLastStudents(struct course currCourse)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Enroll.data", O_RDWR);
        if (fd == -1)
        {
                perror("Error opening Enroll.data");
                return;
