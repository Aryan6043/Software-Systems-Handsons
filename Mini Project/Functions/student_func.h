...
bool checkStudent(struct student currUser)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Student.data", O_RDONLY);
        if (fd == -1)
        {
...
bool changeStudentPass(struct student modUser)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Student.data", O_RDWR);
        if (fd == -1)
        {
                perror("Error opening Student.data");
                return result;
...
bool addStudent(struct student record, int sd)
{
        ...
        int fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Student.data", O_RDWR, 0744);
        if (fd == -1 && errno == ENOENT)
        {
                fd = open("/home/aryan/Documents/Github/Mini-Project/Database/Student.data", O_RDWR | O_CREAT | O_APPEND, 0744);
                record.userID = 0;
                flag = 1;
        }
